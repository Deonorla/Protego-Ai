...
// =======================
// YieldOptimizationSidebar — DuckChain (TON) Edition
// =======================
// ✅ What changed vs your original:
// - Network switched from Sei Testnet to DuckChain Mainnet/Testnet (MetaMask-ready)
// - Cleaned up provider logic + robust network switching
// - Added TON support via auto-wrap to WTON (Wrapped TON) path
// - ABIs fixed (added allowance to ERC20)
// - Safer parsing/formatting + better status messages
// - Optional Testnet toggle & better event handling
//
// ⚠️ Fill these addresses with your actual deployments on DuckChain:
//   - USDC_ADDRESS_DUCKCHAIN
//   - WTON_ADDRESS_DUCKCHAIN (Wrapped TON ERC-20)
//   - PROTEGO_YIELD_VAULT_CORE_ADDRESS
// You can verify tokens/addresses on the DuckChain explorer: https://scan.duckchain.io
// Docs (chainId, RPC, explorers): https://diary.duckchain.io/developers/build-on-duckchain/network-information
//
// IMPORTANT: This component targets ethers v5.x. If you use ethers v6, adapt provider/signing utils.
//   npm i ethers@5
