...
export const SecurityDashboardWrapper: React.FC<
  SecurityDashboardWrapperProps
> = ({ children }) => {
  ...
  return (
    <div
      className={`min-h-screen ${isDark ? "bg-slate-950 text-white" : "bg-slate-50 text-slate-900"} relative overflow-hidden`}
    >
      ...
      >
        <div className=" mx-auto px-6 h-16 flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            <div
              className={`flex items-center gap-3 ${isDark ? "bg-emerald-500/10 border-emerald-500/20 text-emerald-400" : "bg-emerald-50 border-emerald-200 text-emerald-600"} border rounded-lg px-3 py-2`}
            >
            ...
            <div
              className={`flex items-center gap-2 ${isDark ? "bg-blue-500/10 border-blue-500/20 text-blue-400" : "bg-blue-50 border-blue-200 text-blue-600"} border rounded-lg px-3 py-2`}
            >
            ...
            {!isWalletConnected ? (
              ...
              <div className="relative">
                ...
                {showAccountDropdown && (
                  <div
                    className={`absolute top-full right-0 mt-2 w-64 ${isDark ? "bg-slate-900 border-slate-700" : "bg-white border-slate-200"} border rounded-lg shadow-xl z-50`}
                  >
      ...
      <div className="pt-16 flex h-screen">
        ...
        <div
          className={`w-80 border-l ${isDark ? "border-slate-800/50 bg-slate-900/30" : "border-slate-200/50 bg-white/30"} backdrop-blur-sm`}
        >
