...
import { duckMcpService } from "@/services/duckMcpService";
import { ContractAnalysisModal } from "./ContractAnalysisModal";

// Your existing interfaces (keeping them the same)
...
export const ThreatDetectionPanel: React.FC<ThreatDetectionPanelProps> = ({
  ...
  // Your existing useEffect with mock data...
  useEffect(() => {
  ...
  const handleContractAnalysis = (contractAddress?: string) => {
    if (contractAddress) {
  ...
  const handleThreatAction = (threat: Threat) => {
    if (threat.type === "contract") {
      // For contract threats, open the analysis modal
      handleContractAnalysis(threat.source);
    } else {
  ...
  return (
    <div className="h-full flex flex-col bg-white/50 dark:bg-slate-900/30 backdrop-blur-sm">
      ...
      <div className="p-6 border-b border-slate-200 dark:border-slate-800/50">
        ...
        <div className="space-y-2">
          ...
          <button
            ...
            className="w-full bg-gradient-to-r from-blue-500 to-cyan-500 hover:from-blue-600 hover:to-cyan-600 px-4 py-2 rounded-lg text-white font-medium flex items-center justify-center gap-2 transition-all"
          >
      ...
      {/* Your existing threat feed and social alerts sections remain the same */}
              ...
              >
                ...
                <div className="relative">
                  <div className="flex items-start justify-between mb-2">
                    ...
                    <span
                      className={`text-xs px-3 py-1 rounded-full font-medium border ${getSeverityColor(threat.severity)}`}
                    >
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    >
                      ...
                      {threat.type === "contract" ? "Analyze" : "Investigate"}
                    </button>
                  </div>
                </div>
              </div>
                ...
                <div className="flex items-start gap-2 mb-1">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="flex items-center justify-between mt-2">
                      ...
                      <div
                        className={`text-xs font-medium ${getRiskColor(alert.riskLevel)}`}
                      >
      ...
      <ContractAnalysisModal
        ...
        initialAddress={selectedContractAddress}
      />
    </div>
  );
};
